...
#Sch name = JA7
set_property PACKAGE_PIN H1 [get_ports {rgb1[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgb1[0]}]
#Sch name = JA8
set_property PACKAGE_PIN K2 [get_ports {rgb1[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgb1[1]}]
#Sch name = JA9
set_property PACKAGE_PIN H2 [get_ports {rgb1[2]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {tx}]
set_property PULLTYPE PULLUP [get_ports {tx}]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {rx}]
set_property IOSTANDARD LVCMOS33 [get_ports {rx}]
# set_property PULLTYPE PULLUP [get_ports {rx}]
##Sch name = JB3
# set_property PACKAGE_PIN B15 [get_ports {JB[2]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {JB[2]}]
# set_property PULLTYPE PULLUP [get_ports {JB[2]}]
##Sch name = JB4
#set_property PACKAGE_PIN B16 [get_ports {JB[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {JB[3]}]
# Sch name = JB7
# set_property PACKAGE_PIN A15 [get_ports {rgb1[0]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {rgb1[0]}]
# Sch name = JB8
# set_property PACKAGE_PIN A17 [get_ports {rgb1[1]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {rgb1[1]}]
# Sch name = JB9
# set_property PACKAGE_PIN C15 [get_ports {rgb1[2]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {rgb1[2]}]
##Sch name = JB10 
...
#Pmod Header JC
# Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports CPU_RESETN]
set_property IOSTANDARD LVCMOS33 [get_ports CPU_RESETN]
set_property PULLTYPE PULLUP [get_ports CPU_RESETN]
# Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {rd_uart}]
set_property IOSTANDARD LVCMOS33 [get_ports {rd_uart}]
set_property PULLTYPE PULLUP [get_ports {rd_uart}]
# Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {wr_uart}]
set_property IOSTANDARD LVCMOS33 [get_ports {wr_uart}]
set_property PULLTYPE PULLUP [get_ports {wr_uart}]
# Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {pgm_mem}]
set_property IOSTANDARD LVCMOS33 [get_ports {pgm_mem}]
set_property PULLTYPE PULLUP [get_ports {pgm_mem}]
# Sch name = JC7
set_property PACKAGE_PIN L17 [get_ports {rgb2[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgb2[0]}]
# Sch name = JC8
set_property PACKAGE_PIN M19 [get_ports {rgb2[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgb2[1]}]
# Sch name = JC9
set_property PACKAGE_PIN P17 [get_ports {rgb2[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgb2[2]}]
# # Sch name = JC10
# set_property PACKAGE_PIN R18 [get_ports {JC_out[3]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {JC_out[3]}]
